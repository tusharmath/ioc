...
var componentFactory = function (components, container, ctor) {
...
class Container {
    ...
    registerInstance(instance) {
        return createAnnotation((c) => instance, this.componentContainer);
    }
     ...
     */
    registerWithTypes(...components) {
        return createAnnotation(_.partial(componentFactory, components), this.componentContainer);
    }
