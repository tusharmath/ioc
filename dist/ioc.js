...
var componentTypeFactory = _.curry(function(components, container, ctor) {
  ...
  var CtorBound = u.nativeBind(ctor, resolvedComponents);
...
($traceurRuntime.createClass)(Container, {
  resolve: function(component) {
    ...
    var componentDescriptor = this.componentContainer.getDescriptor(component);
  ...
  registerWithInstance: function(instance) {
    return createAnnotation((function(c) {
      return instance;
  ...
  registerWithTypes: function() {
    for (var components = [],
        $__1 = 0; $__1 < arguments.length; $__1++)
      components[$__1] = arguments[$__1];
    return createAnnotation(componentTypeFactory(components), this.componentContainer);
  }
}, {});
module.exports = Container;

//# sourceURL=/Users/tusharmathur/Documents/Projects/ioc/lib/ioc.js
},{"./ComponentContainer":2,"./ComponentDescriptor":3,"./ResolutionQueue":4,"./utils":5,"lodash":6}],2:[function(require,module,exports){
"use strict";
"use strict";
var ComponentDescriptor = require('./ComponentDescriptor');
var ComponentContainer = function ComponentContainer() {
  this.components = new Map();
};
($traceurRuntime.createClass)(ComponentContainer, {
  createDescriptor: function(component, factory) {
    return this.components[component] = new ComponentDescriptor(component, factory);
  },
  getDescriptor: function(component) {
...
//# sourceURL=/Users/tusharmathur/Documents/Projects/ioc/lib/ComponentContainer.js
},{"./ComponentDescriptor":3}],3:[function(require,module,exports){
"use strict";
"use strict";
var ComponentDescriptor = function ComponentDescriptor(ctor, factory) {
  this.ctor = ctor;
  this.isSingleton = false;
  this.factory = factory;
  this._instance = null;
};
($traceurRuntime.createClass)(ComponentDescriptor, {
  set instance(value) {
...
//# sourceURL=/Users/tusharmathur/Documents/Projects/ioc/lib/ComponentDescriptor.js
},{}],4:[function(require,module,exports){
"use strict";
var ResolutionQueue = function ResolutionQueue() {
  this.clear();
};
($traceurRuntime.createClass)(ResolutionQueue, {
  add: function(ctor) {
    if (this.queue[ctor]) {
...
//# sourceURL=/Users/tusharmathur/Documents/Projects/ioc/lib/ResolutionQueue.js
},{}],5:[function(require,module,exports){
"use strict";
"use strict";
var _ = require('lodash');
var utils = {nativeBind: function(ctor, args) {
    args.unshift(null);
    return Function.prototype.bind.apply(ctor, args);
  }};
module.exports = utils;

//# sourceURL=/Users/tusharmathur/Documents/Projects/ioc/lib/utils.js
